            ...
            <div className="grid md:grid-cols-3 gap-6 text-white">
              ...
              <div className="flex flex-col items-center justify-center mt-20">
                ...
                <div className="flex justify-center mt-4">
                  <button className="w-96 bg-white text-gray-600 p-2 rounded-lg flex items-center hover:opacity-90">
                    <Image src={google} alt="google icon" width={45} />
                    <span className="flex-1 text-center text-lg font-bold">Sign Up with Google</span>
                  </button>
                </div>
